...
import { usePaletteHotkey, useRecentQueries } from './hooks.ts';
import { usePanelState } from './panelState.ts';
...
function Panel() {
  ...
  const { input, setInput, selectedId, setSelectedId, toast, showToast, update, panelRef } =
  ...
  return (
    <LabelsProvider labels={labels}>
      <SidePanel {...view} {...callbacks} ref={panelRef} />
    </LabelsProvider>
  );
}
